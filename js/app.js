...
window.nav = function(target) {
    ...
    if(targetView) {
        ...
        if(title) {
            const titles = { 'dashboard':'Dashboard Central', 'cargas':'Romaneios / Rotas', 'rastreio':'Monitoramento Satelital', 'ocorrencias':'Auditoria & Timeline', 'prospeccao':'Radar de Vendas IA', 'clientes':'Base de Lojas', 'equipe':'Equipe & RH', 'frota':'Frota Logística', 'oficina':'Centro de Oficina', 'config':'Configurações APIs', 'relatorios':'Painel de Relatórios' };
